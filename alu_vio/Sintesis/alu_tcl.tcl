...
#
# alu_tcl.tcl: Tcl script for re-creating project 'alu'
#
# Generated by Vivado on Tue Apr 26 21:51:12 -0300 2022
...
#
# 1. This project restoration tcl script (alu_tcl.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/HDL/Codigos/alu_vio/Sintesis/alu.srcs/sources_1/ip/vio_0_1/vio_0.xci"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/HDL/Codigos/alu/Fuentes/alu.vhd"
#    "C:/HDL/Codigos/alu_vio/Fuentes/alu_vio.vhd"
#    "C:/HDL/Codigos/alu_vio/Fuentes/Arty-Z7-10-Master.xdc"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/../../alu/Fuentes/alu.vhd"] \
 [file normalize "${origin_dir}/../Fuentes/alu_vio.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/alu.srcs/sources_1/ip/vio_0_1/vio_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../alu/Fuentes/alu.vhd"
...
set file "$origin_dir/../Fuentes/alu_vio.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "alu_vio" -objects $obj
...
set file "[file normalize "$origin_dir/../Fuentes/Arty-Z7-10-Master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../Fuentes/Arty-Z7-10-Master.xdc"
set file [file normalize $file]
